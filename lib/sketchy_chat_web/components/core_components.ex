defmodule SketchyChatWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SketchyChatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SketchyChatWeb.Gettext, "errors", msg, opts)
    end
  end
